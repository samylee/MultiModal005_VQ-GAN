...
from models.Transformer.transformer import VQGANTransformer
from utils.utils import load_data, plot_images
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset-path', type=str, default='../datasets/flowers/train/rose', help='Path to data.')
